...
export default function Contact() {
  ...
  return (
    <>
      <PageHeader title="Get in" titleAccent="Touch" breadcrumb="Contact" subtitle="Whether you have a project in mind or just want to learn more — our team is ready to help. Response within 24 hours, guaranteed.">
        <GlobeCanvas />
      </PageHeader>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 64, alignItems: 'start' }}>
            ...
            <div className="reveal-left" style={{ position: 'sticky', top: 120 }}>
              ...
              <h2 style={{ marginBottom: 28 }}>Let's Start a <em>Conversation</em></h2>

              {[
                { label: 'Email', value: <a href="mailto:info@asproite.com" style={{ color: 'var(--text)', textDecoration: 'none', transition: 'color 0.2s' }}>info@asproite.com</a> },
                { label: 'Phone', value: <a href="tel:+447555185061" style={{ color: 'var(--text)', textDecoration: 'none', transition: 'color 0.2s' }}>+44 (0)7555185061</a> },
                { label: 'Response Time', value: 'Within 24 hours — usually much faster.' },
              ].map(({ label, value }) => (
              ...
              <div style={{ fontFamily: 'var(--font-head)', fontSize: '0.68rem', fontWeight: 600, color: 'var(--cyan)', letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 14 }}>Our Offices</div>
              {[
                { flag: '🇬🇧', name: 'London HQ', addr: 'Kingsland Road, London, E13 9PA' },
                { flag: '🇮🇳', name: 'Vadodara, India', addr: 'Gotri Road, Vadodara, 390001' },
              ].map(o => (
                <div key={o.name} style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 10, padding: '20px 22px', marginBottom: 14, display: 'flex', gap: 14, transition: 'border-color 0.3s' }}
                  onMouseEnter={e => e.currentTarget.style.borderColor = 'var(--border2)'}
                  onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}>
                  <div style={{ fontSize: '1.6rem' }}>{o.flag}</div>
                  <div>
                    <div style={{ fontFamily: 'var(--font-head)', fontSize: '0.7rem', color: 'var(--cyan)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 4 }}>{o.name}</div>
                    <div style={{ fontSize: '0.85rem', color: 'var(--muted)', lineHeight: 1.6 }}>{o.addr}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="reveal-right" style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 14, padding: 48, position: 'relative', overflow: 'hidden' }}>
              ...
              <h3 style={{ fontFamily: 'var(--font-head)', fontSize: '1.3rem', fontWeight: 700, marginBottom: 6 }}>Send Us a Message</h3>
      ...
      <section style={{ padding: '90px 0', background: 'var(--bg2)', borderTop: '1px solid var(--border)' }}>
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 56 }}>
            <SectionHeader label="FAQs" title="Common" titleAccent="Questions" center />
          </div>
