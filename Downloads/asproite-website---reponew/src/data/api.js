...
// Bump this version string any time you need to force all browsers to reload fresh data
const CACHE_VERSION = 'v4';
const CACHE_VERSION_KEY = 'asproite_cache_version';

// If the browser has an old cache version, clear the DB so it reloads fresh defaults
...
function getDefaults() {
  return {
    ...
    aboutPage: {
      ...
      ctaPrimaryText:'Contact Us →', ctaGhostText:'Our Services',
    },
    servicesPage: {
      pageTitle:'Our', pageTitleAccent:'Services',
      subtitle:'9 specialised IT services covering every stage of your digital journey.',
      ...
      ctaSubtitle:"Tell us about your project and we'll put together a tailored proposal.",
      ctaPrimaryText:'Get a Free Quote →', ctaGhostText:'View Our Work',
    },
    portfolioPage: {
      pageTitle:'Our', pageTitleAccent:'Portfolio',
      ...
      ctaSubtitle:"Ready to build something extraordinary? Let's talk about your goals.",
      ctaPrimaryText:'Start a Conversation →', ctaGhostText:'Our Services',
    },
    contactPage: {
      ...
      faqSectionLabel:'FAQs', faqSectionTitle:'Common', faqSectionTitleAccent:'Questions',
    },
    footer: {
...
// Deep per-section merge — saved values win, new default keys always appear
function loadDB() {
  try {
...
// Web3Forms key — updated automatically when you click Publish in Admin → Settings
export const WEB3FORMS_KEY = localStorage.getItem('asproite_web3key') || 'YOUR_WEB3FORMS_ACCESS_KEY';
