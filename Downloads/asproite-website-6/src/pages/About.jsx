...
export default function About() {
  ...
  return (
    <>
      <PageHeader title="About" titleAccent="Asproite" breadcrumb="About"
      ...
      <section style={{ padding:'110px 0', background:'var(--bg2)', borderTop:'1px solid var(--border)', borderBottom:'1px solid var(--border)' }}>
        <div className="container">
          <div className="reveal" style={{ textAlign:'center', marginBottom:64 }}>
            <SectionHeader label="Our Journey" title="Years of" titleAccent="Innovation" center />
          </div>
      ...
      <CTABox label="Work With Us" title="Ready to" titleAccent="Partner?" subtitle="Let's talk about how Asproite can support your technology journey." primaryText="Contact Us →" primaryTo="/contact" ghostText="Our Services" ghostTo="/services" />
    </>
  );
}
