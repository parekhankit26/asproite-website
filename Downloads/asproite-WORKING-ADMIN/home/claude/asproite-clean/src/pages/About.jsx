...
import { team, timeline, stats } from '../data/siteData.js';
...
export default function About() {
  ...
  return (
    <>
      <PageHeader
        title="About"
        titleAccent="Asproite"
        breadcrumb="About"
        subtitle="Over 05 years of delivering IT excellence across the UK. We're not just a service provider — we're your long-term technology partner."
      >
        <HexBackground />
      </PageHeader>
      ...
      <section style={{ padding: '80px 0', background: 'var(--bg2)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 2 }}>
            {[
              { icon: '🎯', title: 'Our Mission', text: 'To empower businesses with cutting-edge, secure, and scalable IT solutions that drive real growth and digital transformation.' },
              { icon: '👁️', title: 'Our Vision', text: "To be the UK's most trusted technology partner, recognised for innovation, integrity, and measurable client success." },
              { icon: '💎', title: 'Our Values', text: 'Excellence, transparency, and continuous improvement in everything we do — from strategy to responsible hardware disposal.' },
            ].map((m, i) => (
      ...
      <section style={{ padding: '100px 0' }}>
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
            <SectionHeader label="By the Numbers" title="Asproite in" titleAccent="Numbers" center />
          </div>
      ...
      <section style={{ padding: '80px 0', background: 'var(--bg2)', borderTop: '1px solid var(--border)' }}>
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 60 }}>
            <SectionHeader label="Core Values" title="What We" titleAccent="Stand For" center />
          </div>
          <div className="grid-4">
            {[
              { icon: '⚡', t: 'Agility', b: 'We respond fast, adapt faster. Your business needs evolve — we evolve with them.' },
              { icon: '🔒', t: 'Security', b: 'Security-first mindset in every solution — from infrastructure to data destruction.' },
              { icon: '🌱', t: 'Sustainability', b: 'Responsible IT lifecycle management with eco-conscious hardware practices.' },
              { icon: '🤝', t: 'Partnership', b: "We're not vendors — we're partners invested in your long-term success." },
            ].map((v, i) => (
              <div key={v.t} className={`reveal d${i}`} style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 10, padding: '32px 24px', textAlign: 'center', transition: 'border-color 0.3s, transform 0.3s' }}
                ...
                <h4 style={{ fontFamily: 'var(--font-head)', fontSize: '0.95rem', fontWeight: 600, marginBottom: 8 }}>{v.t}</h4>
                <p style={{ fontSize: '0.82rem', color: 'var(--muted)', lineHeight: 1.65 }}>{v.b}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '110px 0', background: 'var(--bg2)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
            <SectionHeader label="Our Journey" title="5+ Years of" titleAccent="Innovation" center />
          </div>
      ...
      <section style={{ padding: '110px 0' }}>
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 60 }}>
            <SectionHeader label="Our People" title="Meet the" titleAccent="Team" center />
          </div>
          <div className="grid-4">
            {team.map((member, i) => (
      ...
      <section style={{ padding: '80px 0', background: 'var(--bg2)', borderTop: '1px solid var(--border)' }}>
        <div className="container">
          <div className="reveal"><SectionHeader label="Our Offices" title="Where We" titleAccent="Operate" /></div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginTop: 48 }}>
            {[
              { flag: '🇬🇧', name: 'London, United Kingdom', addr: 'Kingsland Road\nLondon, E13 9PA\nUnited Kingdom' },
              { flag: '🇮🇳', name: 'Vadodara, India', addr: 'Gotri Road\nVadodara, 390001\nIndia' },
            ].map((o, i) => (
