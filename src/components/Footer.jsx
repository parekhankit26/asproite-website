...
const PAGE_MAP = { 'About Us': '/about', 'Portfolio': '/portfolio', 'Careers': '/careers', 'Contact Us': '/contact', 'Services': '/services', 'Industries': '/industries', 'Referral Program': '/referral-program', 'AI Roadmap': '/get-proposal', 'Home': '/' };
