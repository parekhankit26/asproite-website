...
function getDefaults() {
  return {
    ...
    referralPage: {
      pageTitle:'Refer a Business,', pageTitleAccent:'Get Rewarded',
      subtitle:"Know a business that could use Asproite? Introduce us and we'll make it worth your while.",
      rewardLabel:'The Reward', rewardTitle:'What You', rewardTitleAccent:'Get',
      rewardText:"Ask us about our current referral reward — it's genuinely worth your while. Every successful introduction is recognised, whether you're an existing client, a partner business, or just someone who knows a company that needs better IT.",
      stepsLabel:'How It Works', stepsTitle:'Three Simple', stepsTitleAccent:'Steps',
      steps:[
        {id:1,icon:'✍️',title:'Tell Us Who',body:"Fill in the form below with your details and the business you're referring."},
        {id:2,icon:'🤝',title:'We Take It From There',body:"Our team reaches out, has the conversation, and does right by the business you introduced us to."},
        {id:3,icon:'🎁',title:'You Get Rewarded',body:'If it turns into a client, you get the reward — simple as that.'},
      ],
      formTitle:'Refer a Business', formSubtitle:"Fill in the details below and we'll take it from there.",
